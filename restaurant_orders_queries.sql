...
VALUES
(100,'John'      ,'Anton'    ,'j@ana.tole'          ,'+41 536 436','Heinrichstrasse ' ,8005,'Z�rich'   ,'1'     ),
(101,'Marie'     ,'Medicis'  ,'marie@medi.cis'      ,NULL,'Sihlquai'         ,8005,'Z�rich'   ,'1'     ),
(180,'Anna'      ,'Veritas'  ,'anna@veritas.com'    , NULL, NULL      ,   NULL ,    NULL     ,'1'     ),
(201,'Franz'     ,'Ouali'    ,'franz@ouali.fr'      , NULL,'Sch�tzengasse'    ,8001,'Z�rich'   ,'1'     ),
(213,'Sarah'     ,'Magni'    ,'s.magni@gmail.com'   ,'+41 325 678','Haimstrasse'      ,8001,'Z�rich'   ,'1'     ),
(215,'Alan'      ,'Dupuis'   ,'a.dupuis@gmail.com'  ,'+41 325 413','Regensbergstrasse',8050,'Z�rich'   ,'1'     ),
(221,'Cedric'    ,'Bouteille','bouteille@hotmail.ch', NULL,'P�ntackerweg'     ,8152,'Opfikon'  ,'1'     ),
(225,'Gill'      ,'Baccide'  ,'gill@baccide.com'    ,'+41 432 987','Neugutstrasse'    ,8600,'D�bendorf','1'     ),
(301,'Joe'       ,'Qi'       ,'fake@mail.com'       , NULL, NULL      ,NULL,      NULL   ,'0'     )
;

INSERT INTO restaurant (id, name, phone, address, zip, city)
VALUES
(11 ,'Libanese flavor' ,NULL ,'Kanzleistrasse'   ,8004 ,'Z�rich' ),
(23 ,'Tanaka Sushi'    ,'+41 786 432' ,'Talacker'         ,8001 ,'Z�rich' ),
(38 ,'Le Bistrot'      ,'+33 789 542' ,'T�distrasse'      ,8002 ,'Z�rich' ),
(42 ,'Mama Cucina'     ,NULL ,'Bramenring'       ,8302 ,'Kloten' ),
(51 ,'Sawatdee'        ,NULL ,'Kreuzb�hlstrasse' ,8008 ,'Z�rich' )
; 
...
(19,'Taboul�'               ,'Parsley taboul�'                         , 21.2,        11),
